# ClickSend REST API v3 MCP Server

This MCP (Model Content Protocol) server provides access to ClickSend REST API v3 API functionality through HTTP, HTTPS, and STDIO transport modes.
